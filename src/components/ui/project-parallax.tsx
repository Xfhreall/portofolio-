...
export const Parallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[250vh] py-24 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        Here are the projects I have created using the latest technologies and
        frameworks. These projects are not only my individual work but also
        include collaborative efforts from an incredible team, resulting in

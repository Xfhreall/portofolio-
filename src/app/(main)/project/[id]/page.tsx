      ...
      <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12 md:py-20">
        ...
        >
          <Button
            variant="ghost"
            onClick={() => router.back()}
            className="mb-6 sm:mb-8 text-neutral-400 hover:text-white"
          >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Tech Stack */}
            <div>
              <h3 className="text-sm sm:text-base font-semibold text-neutral-400 uppercase tracking-wider mb-3 sm:mb-4">
                Tech Stack
              </h3>
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {project.techStack.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-neutral-200 bg-neutral-800/80 rounded-lg border border-neutral-700/50"
                  >
                    {tech}
                  </span>
                ))}
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
              ...
              <Link href={project.repoUrl} target="_blank" rel="noopener noreferrer" className="flex-1 sm:flex-none">
                <Button variant="outline" className="w-full sm:w-auto border-neutral-700 hover:bg-neutral-800 h-11 sm:h-12 px-6 sm:px-8">
